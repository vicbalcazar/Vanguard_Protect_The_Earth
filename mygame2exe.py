...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Vanguard_Protect_The_Earth.py"
 
        #Name of program
        self.project_name = "Vanguard"
        ...
        #Auhor of program
        self.author_name = "Victor G. Balcazar"
        self.author_email = "victorbalcazar3@hotmail.com"
        self.copyright = "Copyright (c) 2016 Victor G. Balcazar."
 
        #Description
        self.project_description = "Shmup game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["images", "snd"]
 
        #Extra/excludes python modules
        self.extra_modules = ["random", "os", "pygame", "sys"]
